return function(context)
    ...
    local function updatePlayerEsp(player, precomputed)
        ...
        local tracerColor = showDevTag and devRainbowColor
            or (focusTarget and THEME.focus or (CONFIG.visibilityCheck and displayColor or getTracerColor(player)))
        local camera = getCamera()
        local effectiveBoxMode = getEffectiveBoxMode()
        local outlineColor = showDevTag and devRainbowColor
            or (focusTarget and THEME.focus or (CONFIG.visibilityCheck and displayColor or espColor))
        ...
        elseif effectiveBoxMode == "Chams" then
